...
from src.tools.registration import register_farmer, update_language_preference, update_farmer_profile
...
ALL_TOOLS = [register_farmer, update_language_preference, update_farmer_profile, web_search, detect_language]
